...
import { Activity, Play, Pause, Database, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="glass-card" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <div className="widget-header">
        ...
        <div>
          <span style={{ fontSize: '1.1rem', fontWeight: 700 }}>LSM-Tree Key-Value Engine</span>
          <span style={{ fontSize: '0.75rem', color: 'var(--primary)', display: 'block', letterSpacing: '1px', textTransform: 'uppercase', marginTop: '0.1rem' }}>C++ io_uring WAL & SkipList simulator</span>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.8rem' }}>
              ...
              <span style={{ fontWeight: 'bold', color: 'var(--secondary)' }}>{memTableSize}% Full</span>
            </div>
            <div style={{ height: '8px', background: 'rgba(0,0,0,0.4)', borderRadius: '4px', overflow: 'hidden', border: '1px solid var(--border)' }}>
              <div style={{ width: `${memTableSize}%`, height: '100%', background: 'var(--secondary)', transition: 'width 0.2s ease' }} />
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <span style={{ fontSize: '0.9rem', fontWeight: 'bold', color: 'var(--secondary)', display: 'flex', alignItems: 'center', gap: '0.2rem', marginTop: '0.2rem' }}>
