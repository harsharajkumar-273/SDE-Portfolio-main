  ...
  return (
    <div className="glass-card" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem', border: '1px solid var(--border)' }}>
      <div className="widget-header" style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
        ...
        <div>
          <span style={{ fontSize: '1.1rem', fontWeight: 700, color: 'var(--text-main)' }}>Repost-Radar Deduplicator</span>
          <span style={{ fontSize: '0.75rem', color: 'var(--primary)', display: 'block', letterSpacing: '1px', textTransform: 'uppercase', marginTop: '0.1rem', fontWeight: 600 }}>High-Throughput SIMD LSH stream filter</span>
        </div>
      </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <span style={{ fontSize: '0.9rem', fontWeight: 'bold', fontFamily: 'monospace', color: simdActive ? 'var(--primary)' : 'var(--text-main)' }}>
                {throughput.toLocaleString()} RPS
              </span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontSize: '0.65rem', color: 'var(--text-muted)' }}>FILTERED</span>
              <span style={{ fontSize: '0.9rem', fontWeight: 'bold', fontFamily: 'monospace', color: 'var(--accent-gold)' }}>
                {dedupCount}
              </span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontSize: '0.65rem', color: 'var(--text-muted)' }}>UNIQUE</span>
              <span style={{ fontSize: '0.9rem', fontWeight: 'bold', fontFamily: 'monospace', color: 'var(--secondary)' }}>
                {uniqueCount}
              </span>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', marginTop: '0.4rem' }}>
            <label style={{ fontSize: '0.8rem', color: 'var(--text-muted)', fontWeight: 600 }}>MANUAL TEXT INGESTION TEST</label>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: '0.62rem', fontFamily: 'var(--font-mono)', color: 'var(--text-muted)' }}>repost_radar.log</span>
              <span style={{ 
                fontSize: '0.6rem', 
            ...
            <div style={{
              ...
              {logs.map((log, i) => {
                ...
                const color = isDuplicate ? 'var(--accent-gold)' : isUnique ? 'var(--secondary)' : '#94a3b8';
